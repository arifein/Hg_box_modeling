# Box model from N. Selin (2018) - https://github.com/noelleselin/sixboxmercury.git
# This model is a Python implementation of the box model used in the publication: N. E. Selin, 2014. Global Change and Mercury Cycling: Challenges for Implementing a Global Mercury Treaty. Environmental Toxicology and Chemistry, 33(6):1202-1210.
from numpy import *
